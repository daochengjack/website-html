...
**Note:** The pre-commit hook requires Node.js 16.17+ with Corepack enabled, or a global `pnpm` installation. If Corepack is not available, the hook will fall back to using `npx` to run lint-staged. To enable Corepack (recommended):
